# Internet Shop Frontend Application

## Overview

This application is a template for frontend UI for internet shop development. It is basing on React.
...
Configure configure endpoint path's according to your needs.
